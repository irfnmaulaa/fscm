...
if ($lang['id']!=$language) {
	$get_lang = file_get_contents('https://raw.githubusercontent.com/Den1xxx/cream/master/languages/' . $language . '.json');
	if (!empty($get_lang)) {
...
if (empty($sqlErrorCode)) return __('Success').' â€” '.$sqlFileToExecute;
