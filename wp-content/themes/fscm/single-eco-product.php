              ...
              <div class="self-stretch flex flex-col justify-start items-start gap-2 lg:gap-4">
                <div class="self-stretch flex flex-col justify-start items-start gap-2 lg:gap-4">
                  <div class="self-stretch inline-flex justify-start items-start">
                    <div class="justify-start text-Text-Default-Default text-3xl lg:text-6xl font-bold leading-[76.80px] text-[#E20000]">V-Belt</div>
                  </div>
                </div>
                <div class="self-stretch inline-flex justify-start items-start">
...
<div class="w-full relative"> 
  <div class="container px-16 py-20 single-content flex flex-col gap-5"> 

  <div class="w-full">
    <input type="checkbox" id="accordion-3" class="peer hidden accordion-checkbox">    
    <label for="accordion-3" class="flex justify-between text-[24px] px-4 py-2 items-center cursor-pointer bg-[#FF9191]">
        <div>HONDA</div>
        <div class="transition-transform duration-300 rotate-180 accordion-icon">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="max-h-0 px-4 overflow-hidden transition-all duration-300 peer-checked:max-h-[200vh] peer-checked:my-2">
        ...
        <tr>
        <td>FFG-0D-BLAD-0-20-NFS</td>
        <td>420-102, 14T 37T</td>
        <td>Blade – KWB</td>
        </tr>
        <tr>
        <td>FFG-0D-BLAD-0-20-NFS</td>
  ...
  <div class="w-full">
    ...
    <label for="accordion-2" class="flex justify-between text-[24px] px-4 py-2 items-center cursor-pointer bg-[#FF9191]">
        <div>YAMAHA</div>
        <div class="transition-transform duration-300 rotate-180 accordion-icon">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15 12.5L10 7.5L5 12.5" stroke="var(--Icon-Default-Default, #1E1E1E)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
<div class="w-full relative bg-[#F5F5F5]"> 
  <div class="container px-16 py-20 flex flex-col justify-center items-center gap-10"> 
    ...
    <div class="flex justify-center items-center gap-4 mt-3">
        <a href="<?= site_url('/fscm-products') ?>" class="btn btn-red px-24 py-2 inline-flex gap-2 justify-center items-center text-white bg-[#E20000]">  
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
