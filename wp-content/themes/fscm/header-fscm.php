...
<header class="w-full h-[99px] border-b border-[#D9D9D9] sticky top-0 bg-white z-50">
    <div class="container h-full flex items-center justify-between">
        <div class="logo">
            <a href="<?= get_home_url() ?>">
                <img src="<?= get_template_directory_uri() . '/img/logo-card-fscm.webp' ?>" alt="FSCM">
            </a>
        </div>
        <div class="flex items-center justify-end text-[20px] font-bold gap-6">
            ...
            <a href="<?= get_home_url() . '/fscm-products' ?>" class="py-1.5 px-5 bg-[#1E1E1E] text-white ms-2 -me-2">Find My Parts</a>
        </div>
    </div>
</header>