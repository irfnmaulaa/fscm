    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
      <div class="relative group">
        ...
        <div class="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center gap-3 lg:gap-5 group-hover:opacity-100 lg:opacity-0 bg-[#1E1E1E80] transition-all duration-300 ease-in-out">
          ...
          <a href="<?= site_url('/fscm') ?>" class="px-4 py-2 inline-flex gap-2 justify-center items-center text-white bg-[#2C2C2C]">  
      ...
      <div class="relative group">
        ...
        <div class="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center gap-3 lg:gap-5 opacity-0 group-hover:opacity-0 lg:opacity-100 transition-all duration-300 ease-in-out">
          <img class="h-10 lg:h-[48px]" height="48" width="190" src="<?= get_template_directory_uri() . '/img/logo-card-eco.webp' ?>" />
        </div>
        <div class="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center gap-3 lg:gap-5 group-hover:opacity-100 lg:opacity-0 bg-[#E20000B2] transition-all duration-300 ease-in-out">
          ...
          <a href="<?= site_url('/eco') ?>" class="px-4 py-2 inline-flex gap-2 justify-center items-center text-white bg-[#2C2C2C]">  
