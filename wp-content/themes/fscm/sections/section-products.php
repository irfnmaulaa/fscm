<div id="products" class="w-full relative">
  ...
  <div class="container px-16 py-8 lg:py-20 flex flex-col justify-center items-center gap-5 lg:gap-10">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-6">
      ...
      ?>
        <div class="inline-flex flex-col justify-start items-start border border-gray-300 relative">
          ...
          <div class="w-full h-full p-2 lg:p-4 text-sm lg:text-medium flex flex-col justify-start lg:items-center gap-2 bg-gray-100">
    ...
    <div class="flex flex-col lg:flex-row justify-center items-center gap-4 mt-3">
        <a href="<?= site_url('/' . (is_fscm() ? 'fscm' : 'eco') . '-products') ?>" class="btn <?= is_fscm() ? 'btn-black' : 'btn-red' ?> px-24 py-2 inline-flex gap-2 justify-center items-center text-white bg-[#2C2C2C]">  
        ...
        <a href="https://drive.google.com/file/d/1fAPZYyokPoI1BLh6APJVXOKWq5BRMtjr/view?usp=sharing" target="_blank" class="btn <?= is_fscm() ? 'btn-black' : 'btn-red' ?> px-16 py-2 inline-flex gap-2 justify-center items-center text-white bg-[#2C2C2C]">  
