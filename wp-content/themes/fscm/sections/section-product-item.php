...
<div class="inline-flex flex-col justify-start items-start border border-gray-300 relative group"> 
    <a href="<?= get_permalink($args['product']->ID) ?>" class="w-full aspect-[287/247] overflow-hidden relative z-1">
    ...
    <div class="self-stretch p-2 lg:p-4 gap-2 flex flex-col gap-2 bg-white">
    ...
    <div class="line-clamp-3 text-sm lg:text-medium"><?= $field['subheadline'] ?></div>
    </div>
