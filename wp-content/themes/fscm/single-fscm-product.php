  ...
  <div class="container px-16 py-20 flex flex-col justify-center items-center gap-10">
        <div class="grid grid-cols-2 flex justify-start gap-10">
            ...
            <div class="w-full inline-flex flex-col justify-center items-start gap-6">
              ...
              <a href="#" class="py-1.5 px-5 bg-[#1E1E1E] w-full text-white flex justify-center items-center gap-2">
...
<div class="w-full relative bg-[#F5F5F5]"> 
  <div class="container px-16 py-20 flex flex-col justify-center items-center gap-10"> 
    ...
    <div class="flex justify-center items-center gap-4 mt-3">
        <a href="<?= site_url('/fscm-products') ?>" class="px-24 py-2 inline-flex gap-2 justify-center items-center text-white bg-[#2C2C2C]">  
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
