...
<div class="w-full" id="contact">
    <div class="container py-8 lg:py-20 !max-w-[1108px] flex flex-col-reverse lg:grid lg:grid-cols-[520px_540px] gap-12">
        <div class="w-full p-[2px]" style="background: linear-gradient(305.49deg, #434343 0%, #D9D9D9 55.77%, #737373 100%);">
            <div class="w-full h-full p-6 bg-white inline-flex flex-col justify-start items-center gap-6">
                <div class="flex flex-col justify-start items-center gap-6 w-full justify-center h-full">
                <div class="justify-start text-stone-900 text-[32px] font-semibold leading-10">Email Form</div>
        ...
        <div class="w-full mx-auto !max-w-[720px] bg-white inline-flex justify-start items-start gap-6 flex-wrap content-start">
            <div class="flex-1 inline-flex flex-col justify-start items-start gap-5 lg:gap-6">
                ...
                <div class="accordion border border-[#D9D9D9] w-full">
                    ...
                    <label for="accordion-<?= $i ?>" class="flex justify-between text-lg gap-4 lg:text-[24px] p-6 items-center cursor-pointer hover:bg-gray-100">
                        <div><?= $item['title'] ?></div>
