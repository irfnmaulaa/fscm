...
<div class="hero w-full h-[560px]" style="background: url('<?= get_template_directory_uri() . '/img/hero.webp' ?>'), linear-gradient(180deg, rgba(30, 30, 30, 0.81) 54.33%, rgba(117, 117, 117, 0.081) 100%); background-size: cover; background-position: center; background-repeat: no-repeat; background-blend-mode: multiply;">
  <div class="container !max-w-[882px] flex items-center justify-center text-center flex-col gap-3">
    <h2 class="text-white text-[64px] font-bold">Need Help?</h2>
    <p class="text-white text-[40px] leading-[1.3]">Kami Siap Membantu Kebutuhan Sparepart Anda.</p>
    <a href="#contact" class="btn mt-7 btn-primary text-[24px] font-bold px-5 py-2 inline-flex gap-2 justify-center items-center bg-white border-[#767676]">
...
<div class="w-full" id="contact">
    <div class="container px-16 py-20 !max-w-[1108px] grid grid-cols-2 gap-6">
