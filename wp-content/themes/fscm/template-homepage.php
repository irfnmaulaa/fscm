...
<div class="w-full bg-[#2C2C2C]" id="about">
...
<div class="w-full">
  <div class="container px-16 py-20 flex flex-col justify-center text-center items-center gap-5">
    <div class="text-[32px] font-semibold leading-10">Our Clients</div>
    <div class="text-[24px] mb-8">Supplying precision parts to top automotive brands for over 40 years</div>
