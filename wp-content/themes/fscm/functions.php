...
add_action('init', function () {
    ...
    // register post type
    register_post_type('fscm-product', [
        'labels' => [
            'name' => 'FSCM',
            'singular_name' => 'FSCM',
        ...
        'graphql_single_name' => 'FSCM',
        'graphql_plural_name' => 'FSCMs',
    ]);

    register_taxonomy('fscm-category', 'fscm-product', [
        'labels' => 'Categories',
        'hierarchical' => true,
    ]);
    
    register_post_type('eco-product', [
        'labels' => [
            'name' => 'ECO',
            'singular_name' => 'ECO',
            'add_new' => 'Add New Product',
        ...
        'show_in_graphql' => true,
        'show_in_nav_menus' => true,
        'graphql_single_name' => 'ECO', 
        'graphql_plural_name' => 'ECOs',
    ]);

    register_taxonomy('eco-category', 'eco-product', [
        'labels' => 'Categories',
        'hierarchical' => true,
    ]); 
});
