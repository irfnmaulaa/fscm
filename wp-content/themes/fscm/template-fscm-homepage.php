...
<div id="products" class="w-full relative">
    <svg width="115" height="115" viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute top-0 left-0 w-[115px] h-[115px]">
  <path d="M115 0H0V115L115 0Z" fill="var(--FSCM-RED, #E20000)"/>
  </svg>   
            ...
            <div class="w-full min-w-60 p-8 flex flex-col justify-center items-start gap-6 overflow-hidden">
                ...
                <div class="self-stretch text-white inline-flex flex-col lg:flex-row justify-start items-start gap-4">
                    <div class="w-full lg:w-56 p-3 bg-zinc-800 inline-flex flex-col justify-center items-center gap-2 overflow-hidden">
                        ...
                        <div class="text-white text-xs font-normal leading-5">*Berlaku untuk produk rantai</div>
                    </div>
...
<div id="testimonial" class="w-full relative">
    <svg width="115" height="115" viewBox="0 0 115 115" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute bottom-0 right-0 w-[115px] h-[115px] rotate-180">
  <path d="M115 0H0V115L115 0Z" fill="var(--FSCM-RED, #E20000)"/>
  </svg>   
  <div class="container px-16 py-20 flex flex-col justify-center items-center gap-10">
