...
<div class="w-full relative"> 
  <div class="container px-16 py-8 lg:py-20 flex flex-col justify-center items-center gap-10"> 
    ...
    <div class="flex justify-center items-center gap-4 mt-3">
        <a href="<?= site_url('/eco-products') ?>" class="btn btn-red px-24 py-2 inline-flex gap-2 justify-center items-center">  
